...
echo -e "${RED} #        AUTOSCRIPT CREATED BY PeeRaPol         #    "
echo -e "${RED} #      -----------About Us------------         #    "
echo -e "${RED} #    OS  DEBIAN 7-8-9  OS  UBUNTU 14-16-18     #    "
echo -e "${RED} #       Truemoney Wallet : 095-218-5825        #    "
echo -e "${RED} #               { VPN / SSH }                  #    "
echo -e "${RED} #         BY : PeeRaPol MueangChan               #    "
echo -e "${RED} #    FB : https://m.me/Amkoonp       #    "
echo -e "${RED} =============== OS-32 & 64-bit =================    "
...
echo -e "\033[35;1m
----------------------------------------------
[√] ระบบสคริป  : By PeeRaPol MueangChan 
[√] กรุณารอสักครู่ .....
[√] Loading .....
----------------------------------------------
${NC} "
...
wget -q -O /usr/bin/pass https://shark-host.ga/key/passkey.txt
if ! grep -w -q $passwds /usr/bin/pass; then
clear
echo ""
echo "=============================="
echo "ท่านใส่รหัสผิดกรุณาลองใหม่อีกครั้งหรือติดต่อเจ้าของสคริปเพื่อการช่วยเหลือที่รวดเร็ว"
echo "=============================="
echo ""
rm /usr/bin/pass
rm Install
